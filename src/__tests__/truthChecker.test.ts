describe("checking for truth", () => {
  test("are the littleNumbers < bigNumbers?", () => {
    ...
    let littleNumbers: Array<number> = [1, 3, 6, 8, 9];
    let bigNumbers: Array<number> = [10, 14, 18, 20, 28];
  ...
  test("true", () => {
    let val = "otter"; //set this to a passing value
    expect(val).toBeTruthy();
  });
  test("there is a sequence to this test", () => {
    let values: Array<any> = ["0", true, 2, null]; // set values here - the array will take any type or combo of types.
